...
Always document code. Use Toasts with meaningful German text:
...
- `pnpm test` — Vitest
- Linting: ESLint + `@tanstack/eslint-plugin-query`
- Formatting: Prettier + sort-imports + tailwindcss plugin; Husky + lint-staged on commit

## SumUp

Plain Text Docs: add `index.md` to any SumUp developer URL, e.g. `https://developer.sumup.com/tools/llms/index.md`
