                      ...
                      <CardContent className="relative flex aspect-square items-center justify-center p-6">
                        <AspectRatio ratio={1 / 1}>
                          ...
                          <DownloadIcon
                            ...
                            className="bg-secondary absolute bottom-2 left-2 h-8 w-8 cursor-pointer rounded-md p-1"
                          >
                            Test
                          </DownloadIcon>
                          <AlertDialog>
                            <AlertDialogTrigger
                              asChild
                              className="bg-secondary absolute bottom-2 right-2 h-8 w-8 cursor-pointer rounded-md p-1"
                            >
                              <Trash className="" />
                            </AlertDialogTrigger>
                            <AlertDialogContent>
